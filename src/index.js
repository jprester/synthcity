...
class Game {
  ...
  init() {
    ...
    if (window.userSettings.hasOwnProperty("mode"))
      this.settings.mode = window.userSettings.mode;
    if (window.userSettings.hasOwnProperty("worldSeed"))
      this.settings.worldSeed = window.userSettings.worldSeed;
    if (window.userSettings.hasOwnProperty("music"))
      this.settings.music = window.userSettings.music;
    if (window.userSettings.hasOwnProperty("soundFx"))
      this.settings.soundFx = window.userSettings.soundFx;
    if (window.userSettings.hasOwnProperty("renderScaling"))
    ...
    const light_sun = new DirectionalLight(
